...
export default function ShippingPage() {
  ...
  const handleShippingSubmit = (e: any) => {
    e.preventDefault();
    setIsSubmitted(true);
    console.log("Shipping Data Saved to DB:", formData);
  };
  ...
  const handleTrackOrder = (e: any) => {
    ...
    setEstimatedDays(`Your order #${orderNumber} is on its way! Estimated delivery in ${days} business days 🚚`);
  };

  return (
    <div className="min-h-screen bg-pink-50/40 py-16 px-4 animate-fade-in">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="bg-white rounded-3xl p-8 border border-pink-100 shadow-sm">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 text-sm mt-2">Enter your order number to see the estimated delivery time</p>
          </div>
          ...
          <form onSubmit={handleTrackOrder} className="flex flex-col sm:flex-row gap-3 max-w-xl mx-auto">
            <input 
              ...
              placeholder="Enter Order Number (e.g., LM-12345)" 
        ...
        <div className="bg-white rounded-3xl p-8 border border-pink-100 shadow-sm">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-serif font-bold text-gray-900">Shipping Address 🏠</h2>
            <p className="text-gray-500 text-sm mt-2">Fill in your details so we can deliver your order safely</p>
          </div>

          {isSubmitted ? (
            <div className="text-center py-12">
              <span className="text-6xl block mb-6">✅</span>
              <h3 className="text-2xl font-serif font-bold text-gray-900 mb-4">Address Saved Successfully!</h3>
              <p className="text-gray-500 mb-6">Your shipping details have been recorded to the database.</p>
            ...
            <form onSubmit={handleShippingSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-xs font-semibold text-gray-700 mb-1 uppercase tracking-wider">Governorate</label>
                ...
                <div>
                  <label className="block text-xs font-semibold text-gray-700 mb-1 uppercase tracking-wider">City</label>
                ...
                <div>
                  <label className="block text-xs font-semibold text-gray-700 mb-1 uppercase tracking-wider">District / Area</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-semibold text-gray-700 mb-1 uppercase tracking-wider">Street Name</label>
                ...
                <div>
                  <label className="block text-xs font-semibold text-gray-700 mb-1 uppercase tracking-wider">Building Number</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-semibold text-gray-700 mb-1 uppercase tracking-wider">Floor</label>
                ...
                <div>
                  <label className="block text-xs font-semibold text-gray-700 mb-1 uppercase tracking-wider">Apartment</label>
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1 uppercase tracking-wider">Nearby Landmark (Optional)</label>
